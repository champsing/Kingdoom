...
execute if score @s lottery matches 0 run give @a[tag=lottery] diamond_helmet[attribute_modifiers=[{type:"generic.max_health",amount:5,operation:"add_value",id:"be713292-dd26-464a-9c9a-becd221661e0",slot:"head"},{type:"generic.armor",amount:3,operation:"add_value",id:"0000000a-0000-000a-0000-000a0000000a",slot:"head"}]]
...
execute if score @s lottery matches 1 run give @a[tag=lottery] diamond_chestplate[attribute_modifiers=[{type:"generic.knockback_resistance",amount:0.1d,operation:"add_value",id:"be713292-dd26-464a-9c9a-becd221661e0",slot:"chest"},{type:"generic.armor",amount:3,operation:"add_value",id:"00000014-0000-0014-0000-001400000014",slot:"chest"}]]
...
execute if score @s lottery matches 2 run give @a[tag=lottery] diamond_leggings[attribute_modifiers=[{type:"generic.attack_speed",amount:0.7d,operation:"add_value",id:"be713292-dd26-464a-9c9a-becd221661e0",slot:"legs"},{type:"generic.armor",amount:3,operation:"add_value",id:"0000001e-0000-001e-0000-001e0000001e",slot:"legs"}]]
...
execute if score @s lottery matches 3 run give @a[tag=lottery] diamond_boots[attribute_modifiers=[{type:"generic.attack_damage",amount:0.5d,operation:"add_value",id:"be713292-dd26-464a-9c9a-becd221661e0",slot:"feet"},{type:"generic.armor",amount:3,operation:"add_value",id:"00000028-0000-0028-0000-002800000028",slot:"feet"}]]
