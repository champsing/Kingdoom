...
execute if score @s lottery matches 4 run give @a[tag=lottery] potion[potion_contents={potion:"minecraft:regeneration"}]
...
execute if score @s lottery matches 13 run give @a[tag=lottery] enchanted_book[stored_enchantments={"minecraft:protection":3}]
...
execute if score @s lottery matches 14 run give @a[tag=lottery] enchanted_book[stored_enchantments={"minecraft:efficiency":4}]
