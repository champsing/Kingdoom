...
execute if score @s lottery matches 4 run give @a[tag=lottery] potion[potion_contents={potion:"minecraft:strong_swiftness"}]
...
execute if score @s lottery matches 5 run give @a[tag=lottery] potion[potion_contents={potion:"minecraft:strong_leaping"}]
