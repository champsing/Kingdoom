...
data modify block ~ ~ ~ front_text.messages[2] set value {"score":{"name":"目標分數","objective":"menu"},"bold":true,"click_event":{"action":"run_command","command":"playsound entity.player.attack.sweep ambient @s"}}