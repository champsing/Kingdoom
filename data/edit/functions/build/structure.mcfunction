...
execute if data entity @s ArmorItems[1].tag run data modify storage build:number number prepend from entity @s ArmorItems[1].tag
...
data modify entity @s ArmorItems[1].tag.name set from block ~ ~ ~ name
