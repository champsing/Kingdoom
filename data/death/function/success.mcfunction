...
execute if entity @s[scores={event_curse=1}] run summon item ~ ~ ~ {CustomName:{"text":"噩運水晶"},CustomNameVisible:1b,Item:{id:"minecraft:heart_of_the_sea",components:{"minecraft:custom_name":{"text":"噩運水晶","italic":false}},count:1},Age:-32768,PickupDelay:50}
...
clear @s gold_nugget
clear @s written_book[custom_data~{KingBook:1}]
clear @s written_book[custom_data~{book:"favorability"}]
