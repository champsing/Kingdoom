...
clear @a[tag=!Rking,team=red] written_book{KingBook:1}
clear @a[tag=!Bking,team=blue] written_book{KingBook:1}
...
#---升級台---
execute at @e[type=armor_stand,tag=upgrade] unless block ~ ~ ~ dispenser{Items:[{Slot:0b,id:"minecraft:diamond_chestplate",Count:1b},{Slot:1b,id:"minecraft:diamond_sword",Count:1b},{Slot:2b,id:"minecraft:diamond_axe",Count:1b},{Slot:3b,id:"minecraft:diamond_pickaxe",Count:1b},{Slot:4b,id:"minecraft:light_gray_stained_glass_pane",Count:1b},{Slot:5b,id:"minecraft:anvil",Count:1b},{Slot:6b,id:"minecraft:armor_stand",Count:1b},{Slot:7b,id:"minecraft:chest",Count:1b},{Slot:8b,id:"minecraft:shield",Count:1b}]} as @a[team=!spec] run function upgrade:check
...
execute at @e[tag=forge,team=red_edit] if block ~ ~ ~ end_portal_frame[eye=true] as @e[type=armor_stand,tag=forge_sword,tag=!forge_success,distance=..0.5,limit=1] if data entity @s HandItems[0].tag.forge unless entity @s[nbt={HandItems:[{tag:{forge:3}}]}] run function forge:success_red
execute at @e[tag=forge,team=blue_edit] if block ~ ~ ~ end_portal_frame[eye=true] as @e[type=armor_stand,tag=forge_sword,tag=!forge_success,distance=..0.5,limit=1] if data entity @s HandItems[0].tag.forge unless entity @s[nbt={HandItems:[{tag:{forge:3}}]}] run function forge:success_blue
execute as @e[type=armor_stand,tag=forge_success] at @s unless data entity @s HandItems[0].id run function forge:success
clear @a[team=!spec] #upgrade:weapon{RepairCost:1,NoGrind:1b}
...
clear @a[tag=!vote] written_book{book:"spy"}
