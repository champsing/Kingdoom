#---保衛---
execute if entity @s[team=red] run tag @n[team=red_edit,tag=build,tag=!Kkit05,limit=1] add Kkit05
execute if entity @s[team=blue] run tag @n[team=blue_edit,tag=build,tag=!Kkit05,limit=1] add Kkit05
