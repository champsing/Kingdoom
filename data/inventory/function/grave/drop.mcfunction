...
data modify entity @e[type=villager,tag=grave,limit=1,distance=..0.3,sort=nearest] ArmorItems[3].components.minecraft:custom_data.save set from entity @s Inventory
