...
item replace entity @a[team=red,tag=Rking] armor.head with golden_helmet{display:{Name:'{"text":"皇冠","italic":false}'},HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}]}
item replace entity @a[team=blue,tag=Bking] armor.head with golden_helmet{display:{Name:'{"text":"皇冠","italic":false}'},HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}]}
