execute at @e[type=armor_stand,tag=upgrade,team=red_edit,limit=1] run setblock ~ ~1 ~ red_shulker_box{lock:{components:{"minecraft:custom_name":"§c紅隊保險箱鑰匙"}},CustomName:{"text":"保險箱"}}
