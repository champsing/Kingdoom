...
execute unless items entity @s armor.chest elytra run item replace entity @s armor.chest with chainmail_chestplate[custom_data={upgrade:2}]
execute if items entity @s armor.chest elytra run give @s chainmail_chestplate[custom_data={upgrade:2}]
