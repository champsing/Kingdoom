#---巨人---
tag @s add event15
tag @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:3b}]}] add event15_cart
tag @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:5b}]}] add event15_colossal
...
tellraw @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:4b}]}] ["",{"text":">> ","bold":true,"color":"gold"},{"text":"你已繼承"},{"text":"顎巨人","color":"gold"},{"text":"的力量"}]
tellraw @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:5b}]}] ["",{"text":">> ","bold":true,"color":"gold"},{"text":"你已繼承"},{"text":"超大型巨人","color":"gold"},{"text":"的力量"}]
...
tellraw @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:4b}]}] ["",{"text":">> ","bold":true,"color":"gold"},{"text":"顎巨人","color":"gold"},{"text":": 獲得加速 II和挖掘加速 II效果 (1:30)"}]
tellraw @s[nbt={active_effects:[{id:"minecraft:unluck",amplifier:5b}]}] ["",{"text":">> ","bold":true,"color":"gold"},{"text":"超大型巨人","color":"gold"},{"text":": 獲得緩速 I效果, 凋零半徑5格內的玩家 (1:30)"}]
