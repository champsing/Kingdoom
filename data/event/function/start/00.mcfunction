...
execute at @e[type=armor_stand,tag=middle] run summon item ~ ~2 ~ {CustomName:{"text":"噩運水晶"},CustomNameVisible:1b,Item:{id:"minecraft:heart_of_the_sea",components:{"minecraft:custom_name":{"text":"噩運水晶","italic":false}},count:1b},Age:-32768,PickupDelay:50}
