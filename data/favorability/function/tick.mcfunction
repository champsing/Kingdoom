...
give @a[team=!spec,scores={fav_book=0}] written_book[written_book_content={pages:[["",{"text":"好感系統","bold":true,"color":"gold"},"\u00a7r",{"text":"\n【"},{"text":"查看好感","click_event":{"action":"run_command","command":"/trigger fav_op set 1"},"hover_event":{"action":"show_text","value":[{"text":"查看所有玩家的好感度"}]}},{"text":"】\n【"},{"text":"約會","click_event":{"action":"run_command","command":"/trigger fav_op set 2"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家發出約會邀請\n條件: 與對方好感大於60%"}]}},{"text":"】\n【"},{"text":"求婚","click_event":{"action":"run_command","command":"/trigger fav_op set 3"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家求婚\n條件: 與對方好感大於80%"}]}},{"text":"】\n【"},{"text":"送禮","click_event":{"action":"run_command","command":"/trigger fav_op set 4"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家送出副手拿著的物品\n條件: 無"}]}},{"text":"】\n【"},{"text":"出軌","click_event":{"action":"run_command","command":"/trigger fav_op set 5"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家出軌\n條件: 已結婚, 與對方好感大於70%"}]}},{"text":"】\n【"},{"text":"抓姦","click_event":{"action":"run_command","command":"/trigger fav_op set 6"},"hover_event":{"action":"show_text","value":[{"text":"向你的伴侶提出有小三的質疑\n條件: 你的伴侶"}]}},{"text":"】\n【"},{"text":"吵架","click_event":{"action":"run_command","command":"/trigger fav_op set 7"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家減少10好感度\n條件: 花費10元"}]}},{"text":"】\n【"},{"text":"決鬥","click_event":{"action":"run_command","command":"/trigger fav_op set 8"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家提出決鬥\n條件: 敵隊, 與對方好感小於30%"}]}},{"text":"】\n【"},{"text":"結仇","click_event":{"action":"run_command","command":"/trigger fav_op set 9"},"hover_event":{"action":"show_text","value":[{"text":"向一位玩家成為宿敵\n條件: 與對方好感小於10%"}]}},{"text":"】"}]],author:"丘比特",title:"好感系統操作書"},custom_data={book:"favorability"}]
