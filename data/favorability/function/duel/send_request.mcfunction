...
tellraw @a[tag=ask_duel_target,limit=1] ["§6§l>> §r與 ",{"selector":"@s"}," 決鬥 ",{"text":"§a【接受】","click_event":{"action":"run_command","command":"/trigger duel_feedback set 1"},"hover_event":{"action":"show_text","value":["接受與 ",{"selector":"@s"}," 決鬥"]}}," ",{"text":"§c【拒絕】","click_event":{"action":"run_command","command":"/trigger duel_feedback set 2"},"hover_event":{"action":"show_text","value":["拒絕與 ",{"selector":"@s"}," 決鬥"]}}]