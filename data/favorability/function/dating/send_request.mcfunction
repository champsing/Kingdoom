...
tellraw @a[tag=ask_date_target,limit=1] ["§6§l>> §r與 ",{"selector":"@s"}," 約會 ",{"text":"§a【答應】","click_event":{"action":"run_command","command":"/trigger date_feedback set 1"},"hover_event":{"action":"show_text","value":["答應與 ",{"selector":"@s"}," 約會"]}}," ",{"text":"§c【拒絕】","click_event":{"action":"run_command","command":"/trigger date_feedback set 2"},"hover_event":{"action":"show_text","value":["拒絕與 ",{"selector":"@s"}," 約會"]}}]